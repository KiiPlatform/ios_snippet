...
private func snippet_1_non_blocking(){
  Kii.listTopics { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
    if error != nil {
      // do something with error
      return
    }
    ...
    if resultObj!.hasNext {
      Kii.listTopics((resultObj!.paginationKey)!, block: { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
        if error != nil {
          // do something with error
          return
        }
...
private func snippet_2_non_blocking(){
  let aGroup = KiiGroup(id: "groupID")
  aGroup.listTopics { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
    if error != nil {
      // do something with error
      return
    }
    ...
    if resultObj!.hasNext {
      aGroup.listTopics(resultObj!.paginationKey, block: { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
        if error != nil {
          // do something with error
          return
        }
...
private func snippet_3_non_blocking(){
  ...
  aUser.listTopics { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
    if error != nil {
      // do something with error
      return
    }
    ...
    if resultObj!.hasNext {
      aUser.listTopics(resultObj!.paginationKey, block: { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
        if error != nil {
          // do something with error
          return
        }
...
private func snippet_4_non_blocking(){
  ...
  aThing.listTopics { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
    if error != nil {
      // do something with error
      return
    }
    ...
    if resultObj!.hasNext {
      aThing.listTopics(resultObj!.paginationKey, block: { (resultObj : KiiListResult?, callerObject : AnyObject?, error ) -> Void in
        if error != nil {
          // do something with error
          return
        }
