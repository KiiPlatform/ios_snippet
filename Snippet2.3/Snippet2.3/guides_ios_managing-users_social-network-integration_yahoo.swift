//
//  managing-users_social-network-integration_ yahoo.swift
//  Snippet
//
...
//MARK: path managing-users/social-network-integration/yahoo/
...
private func snippet_1(){
  func myRegistrationMethod(){
    ...
    KiiSocialConnect.logIn(.Yahoo, options: options) { (retUser : KiiUser?, provider : KiiConnectorProvider, retError : NSError?) -> Void in
      if (retError != nil) {
        // Error handling
        return
      }
