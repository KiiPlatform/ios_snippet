//
//  managing-users_social-network-integration_ dropbox.swift
//  Snippet
//
...
//MARK: path managing-users/social-network-integration/dropbox/
...
private func snippet_1(){
  func myRegistrationMethod(){
    ...
    KiiSocialConnect.logIn(.Dropbox, options: options) { (retUser : KiiUser?, provider : KiiConnectorProvider, retError : NSError?) -> Void in
      if (retError != nil) {
        // Error handling
        return
      }
...
private func snippet_3(){
  let dict  = KiiSocialConnect.accessTokenDictionary(.Dropbox)! as NSDictionary
