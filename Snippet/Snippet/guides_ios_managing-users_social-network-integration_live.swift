//
//  managing-users_social-network-integration_ live.swift
//  Snippet
//
...
//MARK: path managing-users/social-network-integration/live/
...
private func snippet_1(){
  func myRegistrationMethod(){
    ...
    KiiSocialConnect.logIn(.Live, options: options) { (retUser : KiiUser?, provider : KiiConnectorProvider, retError : NSError?) -> Void in
      if (retError != nil) {
        // Error handling
        return
      }
